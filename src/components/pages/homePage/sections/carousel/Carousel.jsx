...
export default function MoonCarousel() {
  ...
  const goNext = () => setCurrent((c) => (c + 1) % items.length);
   ...
   return (
    <section className="moon-carousel-section">
      <div className="moon-carousel-header">
        <h2 className="moon-carousel-title">La Luna en la biblioteca de la NASA</h2>
        <p className="moon-carousel-subtitle">
          Una selección de imágenes de la Luna sacadas de la biblioteca de imágenes
  de la NASA: fotos, ilustraciones y más.
        </p>
      </div>
